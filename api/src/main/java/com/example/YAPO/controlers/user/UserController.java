...
public class UserController {
    ...
    public ResponseEntity<User> registerUserPage(
    ...
    @PostMapping("/login")
    public ResponseEntity<Map<String, String>> loginUserPage(
    ...
    public ResponseEntity<Void> deactivateUserPage(
            @AuthenticationPrincipal MyUserDetails userDetails) {
    ...
    public ResponseEntity<Void> forgotPasswordPage(
            @RequestBody @Valid UsernameField username) {
        userService.forgotPassword(username.getUsername());
        return ResponseEntity.ok().build();
    }

    @PostMapping("/reactivate-user")
    public ResponseEntity<Void> restoreUserPage(
            @RequestBody UsernameField usernameField){
        userService.reactivateUser(usernameField.getUsername());
        return ResponseEntity.ok().build();
    }

    @GetMapping( "/enable")
    public ResponseEntity<Void> enableUserPage(
